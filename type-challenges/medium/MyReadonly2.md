...
```ts
type MyReadonly2<T extends object, PropertiesOfT extends keyof T = keyof T> = {
  readonly [KeyT in PropertiesOfT]: T[KeyT]
} & {
  [KeyT in Exclude<keyof T, PropertiesOfT>]: T[KeyT]
}
```
